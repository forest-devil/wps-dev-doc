...
1. 打开 AirScript 编辑工具弹出编辑页面。
2. 点击 AirScript 编辑工具上方的服务。
3. 点击添加服务。 ![alt text](https://cloudcdn.qwps.cn/open/kingsoft_open_docs/airscript-advanced1.BNcn59rm.png)
4. 选择一项服务，然后点击确认。
...
- JSSDK 3.0 版本通过微前端技术加载在线文档，有着跟客户系统一体化的体验
...
> 以快速创建一张表为例，下面分别是在浏览器环境和 AirScript 脚本编辑器中的使用示例
...
## 133 API 文档 / 字段 / 图片和附件字段 / 仅可通过移动端拍摄上传
...
## 192 API 文档 / API_Sheet_FieldDescriptors
...
## 196 API 文档 / API_Sheet_RecordRange
...
## 198 API 文档 / API_Sheet_AddDescription
...
## 199 API 文档 / API_Sheet_AppendFromCloud
...
## 200 API 文档 / API_Sheet_AppendFromLocal
...
## 202 API 文档 / API_Sheet_CreateFields
...
## 204 API 文档 / API_Sheet_DeleteFields
...
## 206 API 文档 / API_Sheet_GetFields
...
## 208 API 文档 / API_Sheet_UpdateFields
...
## 209 API 文档 / API_Sheet_OnCreateRecord
...
## 212 API 文档 / API_Sheets_Sheets 对象
...
## 215 API 文档 / API_Sheets_GetActiveSheetId
...
## 216 API 文档 / API_Sheets_GetActiveSheetIndex
...
## 218 API 文档 / API_Sheets_ItemById
...
## 220 API 文档 / API_Sheets_OnCreateSheet
...
## 221 API 文档 / API_CalendarView_CalendarView 对象
...
## 222 API 文档 / API_CalendarView_BeginField
...
## 223 API 文档 / API_CalendarView_EndField
...
## 224 API 文档 / API_CalendarView_TimelineColor
...
## 225 API 文档 / API_CalendarView_TimelineColorFollowField
...
## 226 API 文档 / API_CalendarView_TimelineColorType
...
## 227 API 文档 / API_CalendarView_TitleField
...
## 228 API 文档 / API_CardViewUI_CardViewUI 对象
...
## 229 API 文档 / API_CardViewUI_ViewMode
...
## 230 API 文档 / API_GanttView_GanttView 对象
...
## 231 API 文档 / API_GanttView_BeginField
...
## 232 API 文档 / API_GanttView_Calendars
...
## 233 API 文档 / API_GanttView_EndField
...
## 234 API 文档 / API_GanttView_IsOnlyWorkDay
...
## 235 API 文档 / API_GanttView_TimelineColor
...
## 236 API 文档 / API_GanttView_TimelineColorFollowField
...
## 237 API 文档 / API_GanttView_TimelineColorType
...
## 238 API 文档 / API_GanttViewUI_GanttViewUI 对象
...
## 239 API 文档 / API_GanttViewUI_GanttGridFold
...
## 240 API 文档 / API_GanttViewUI_ViewMode
...
## 241 API 文档 / API_GanttViewUI_NextPage
...
## 242 API 文档 / API_GanttViewUI_PrevPage
...
## 243 API 文档 / API_GanttViewUI_Today
...
## 244 API 文档 / API_GridView_GridView 对象
...
## 245 API 文档 / API_GridView_FrozenCols
...
## 246 API 文档 / API_GridView_RowHeight
...
## 247 API 文档 / API_QueryView_QueryView 对象
...
## 248 API 文档 / API_QueryView_BackgroundImage
...
## 249 API 文档 / API_QueryView_QueryFields
...
## 251 API 文档 / API_View_Description
...
## 257 API 文档 / API_View_IsPersonal
...
## 259 API 文档 / API_View_RecordRange
...
## 270 API 文档 / API_ViewShare_ViewShare 对象
...
## 271 API 文档 / API_ViewShare_CanAddRemoveRecords
...
## 272 API 文档 / API_ViewShare_EditableFieldsInfo
...
## 273 API 文档 / API_ViewShare_EditableRecType
...
## 274 API 文档 / API_ViewShare_ShareUrl
...
## 275 API 文档 / API_ViewShare_SharedLinkInfo
...
## 276 API 文档 / API_ViewShare_VisibleRecType
...
## 277 API 文档 / API_ViewShare_ChangePermission
...
## 278 API 文档 / API_ViewShare_SetEnable
...
## 280 API 文档 / API_Views_ActiveView
...
## 287 API 文档 / API_Record_Record 对象
...
## 294 API 文档 / API_RecordRange_RecordRange 对象
...
## 295 API 文档 / API_RecordRange_Count
...
## 296 API 文档 / API_RecordRange_FieldId
...
## 297 API 文档 / API_RecordRange_Font
...
## 299 API 文档 / API_RecordRange_Index
...
## 300 API 文档 / API_RecordRange_Interior
...
## 301 API 文档 / API_RecordRange_Text
...
## 302 API 文档 / API_RecordRange_Value
...
## 303 API 文档 / API_RecordRange_Add
...
## 304 API 文档 / API_RecordRange_Condition
...
## 305 API 文档 / API_RecordRange_Delete
...
## 306 API 文档 / API_RecordRange_Item
...
## 307 API 文档 / API_RecordRange_Select
...
## 308 API 文档 / API_RecordRange_SetValues
...
## 309 API 文档 / API_RecordRange_OnDeleteRecord
...
## 310 API 文档 / API_RecordRange_OnUpdate
...
## 311 API 文档 / API_Records_Records 对象
...
## 315 API 文档 / API_Records_FindNext
...
## 316 API 文档 / API_Records_FindPrevious
...
## 318 API 文档 / API_AddressField_AddressField 对象
...
## 319 API 文档 / API_AddressField_IsDetailedAddress
...
## 320 API 文档 / API_AddressField_IsUsePresetAddress
...
## 321 API 文档 / API_AddressField_Level
...
## 322 API 文档 / API_AddressField_PresetAddress
...
## 323 API 文档 / API_Attachment_Attachment 对象
...
## 324 API 文档 / API_Attachment_FileId
...
## 325 API 文档 / API_Attachment_FileName
...
## 326 API 文档 / API_Attachment_FileSize
...
## 327 API 文档 / API_Attachment_FileType
...
## 328 API 文档 / API_Attachment_ImgSize
...
## 329 API 文档 / API_Attachment_LinkUrl
...
## 330 API 文档 / API_AttachmentField_AttachmentField 对象
...
## 331 API 文档 / API_AttachmentField_DisplayStyle
...
## 332 API 文档 / API_AttachmentField_IsOnlyCameraUpload
...
## 333 API 文档 / API_AutoLinkCondition_AutoLinkCondition 对象
...
## 334 API 文档 / API_AutoLinkCondition_DateIntersectedValues
...
## 335 API 文档 / API_AutoLinkCondition_IntersectedConds
...
## 336 API 文档 / API_AutoLinkCondition_LinkSheetFieldId
...
## 337 API 文档 / API_AutoLinkCondition_OpType
...
## 338 API 文档 / API_AutoLinkCondition_SheetCondContents
...
## 339 API 文档 / API_AutoLinkCondition_SheetCondType
...
## 340 API 文档 / API_AutoLinkConditions_AutoLinkConditions 对象
...
## 341 API 文档 / API_AutoLinkConditions_Count
...
## 342 API 文档 / API_AutoLinkConditions_Add
...
## 343 API 文档 / API_AutoLinkConditions_Delete
...
## 344 API 文档 / API_AutoLinkConditions_Item
...
## 345 API 文档 / API_AutoLinkGroup_AutoLinkGroup 对象
...
## 346 API 文档 / API_AutoLinkGroup_Conditions
...
## 347 API 文档 / API_AutoLinkGroups_AutoLinkGroups 对象
...
## 348 API 文档 / API_AutoLinkGroups_Count
...
## 349 API 文档 / API_AutoLinkGroups_Add
...
## 350 API 文档 / API_AutoLinkGroups_Delete
...
## 351 API 文档 / API_AutoLinkGroups_Item
...
## 352 API 文档 / API_AutomationField_AutomationField 对象
...
## 353 API 文档 / API_AutomationField_ContactField
...
## 354 API 文档 / API_AutomationField_ExecuteTime
...
## 355 API 文档 / API_AutomationField_TriggerField
...
## 356 API 文档 / API_AutomationField_Type
...
## 357 API 文档 / API_ButtonField_ButtonField 对象
...
## 358 API 文档 / API_ButtonField_BackgroundColor
...
## 359 API 文档 / API_ButtonField_Icon
...
## 360 API 文档 / API_ButtonField_SuccessText
...
## 361 API 文档 / API_ButtonField_Text
...
## 362 API 文档 / API_ButtonField_TextColor
...
## 363 API 文档 / API_CascadeField_CascadeField 对象
...
## 364 API 文档 / API_CascadeField_AllCascadeOption
...
## 365 API 文档 / API_CascadeField_IsDisplayAllLevel
...
## 366 API 文档 / API_CascadeField_Title
...
## 367 API 文档 / API_CascadeOption_CascadeOption 对象
...
## 368 API 文档 / API_CascadeOption_Children
...
## 369 API 文档 / API_CascadeOption_Id
...
## 370 API 文档 / API_CascadeOption_Value
...
## 371 API 文档 / API_CascadeOptions_CascadeOptions 对象
...
## 372 API 文档 / API_CascadeOptions_Count
...
## 373 API 文档 / API_CascadeOptions_Add
...
## 374 API 文档 / API_CascadeOptions_Item
...
## 375 API 文档 / API_ContactField_ContactField 对象
...
## 376 API 文档 / API_ContactField_IsSupportMulti
...
## 377 API 文档 / API_ContactField_IsSupportNotice
...
## 378 API 文档 / API_DBCellValue_DBCellValue 对象
...
## 379 API 文档 / API_DBCellValue_Value
...
## 380 API 文档 / API_DateField_DateField 对象
...
## 381 API 文档 / API_DateField_IsShowHoliday
...
## 382 API 文档 / API_DateField_IsShowTime
...
## 383 API 文档 / API_DateField_IsShowWeek
...
## 385 API 文档 / API_Field_FieldDescriptor
...
## 393 API 文档 / API_FieldDescriptor_FieldDescriptor 对象
...
## 394 API 文档 / API_FieldDescriptor_DefaultVal
...
## 395 API 文档 / API_FieldDescriptor_DefaultValType
...
## 396 API 文档 / API_FieldDescriptor_Description
...
## 397 API 文档 / API_FieldDescriptor_Id
...
## 398 API 文档 / API_FieldDescriptor_IsSyncField
...
## 399 API 文档 / API_FieldDescriptor_IsValueUnique
...
## 400 API 文档 / API_FieldDescriptor_Name
...
## 401 API 文档 / API_FieldDescriptor_NumberFormat
...
## 402 API 文档 / API_FieldDescriptor_Type
...
## 403 API 文档 / API_FieldDescriptor_Apply
...
## 404 API 文档 / API_FieldDescriptor_Delete
...
## 405 API 文档 / API_FieldDescriptor_OnDelete
...
## 406 API 文档 / API_FieldDescriptor_OnUpdate
...
## 407 API 文档 / API_FieldDescriptors_FieldDescriptors 对象
...
## 408 API 文档 / API_FieldDescriptors_Count
...
## 409 API 文档 / API_FieldDescriptors_AddField
...
## 410 API 文档 / API_FieldDescriptors_Delete
...
## 411 API 文档 / API_FieldDescriptors_FieldDescriptor
...
## 412 API 文档 / API_FieldDescriptors_Item
...
## 413 API 文档 / API_FieldDescriptors_OnCreate
...
## 414 API 文档 / API_Fields_Fields 对象
...
## 417 API 文档 / API_FormulaField_FormulaField 对象
...
## 418 API 文档 / API_FormulaField_Formula
...
## 419 API 文档 / API_FormulaField_IsShowPercentAsProgress
...
## 420 API 文档 / API_FormulaField_ValueType
...
## 421 API 文档 / API_LinkField_LinkField 对象
...
## 422 API 文档 / API_LinkField_AutoLinkGroups
...
## 423 API 文档 / API_LinkField_IsAutoLink
...
## 424 API 文档 / API_LinkField_IsSupportMultiLinks
...
## 425 API 文档 / API_LinkField_LinkSheet
...
## 426 API 文档 / API_LinkField_LinkView
...
## 427 API 文档 / API_LookupField_LookupField 对象
...
## 428 API 文档 / API_LookupField_LinkFieldId
...
## 429 API 文档 / API_LookupField_LookupFieldId
...
## 430 API 文档 / API_LookupField_LookupSheetId
...
## 431 API 文档 / API_LookupField_LookupType
...
## 432 API 文档 / API_NumberField_NumberField 对象
...
## 433 API 文档 / API_NumberField_IsShowThousand
...
## 434 API 文档 / API_RatingField_RatingField 对象
...
## 435 API 文档 / API_RatingField_MaxRating
...
## 436 API 文档 / API_SelectField_SelectField 对象
...
## 437 API 文档 / API_SelectField_IsAddItemWhenInputting
...
## 438 API 文档 / API_SelectField_Items
...
## 439 API 文档 / API_TextLinkRun_TextLinkRun 对象
...
## 440 API 文档 / API_TextLinkRun_Address
...
## 441 API 文档 / API_TextLinkRun_Length
...
## 442 API 文档 / API_TextLinkRun_LinkRunsType
...
## 443 API 文档 / API_TextLinkRun_Pos
...
## 444 API 文档 / API_TextLinkRuns_TextLinkRuns 对象
...
## 445 API 文档 / API_TextLinkRuns_Count
...
## 446 API 文档 / API_TextLinkRuns_Item
...
## 447 API 文档 / API_UrlField_UrlField 对象
...
## 448 API 文档 / API_UrlField_HyperLinkText
...
## 449 API 文档 / API_WatchedField_WatchedField 对象
...
## 450 API 文档 / API_WatchedField_IsWatchedAll
...
## 451 API 文档 / API_WatchedField_WatchedFields
...
## 454 API 文档 / API_Sort_IsAscending
...
## 460 API 文档 / API_Sorts_ChangeOrder
...
## 462 API 文档 / API_Criteria_Criteria 对象
...
## 466 API 文档 / API_Filter_Filter 对象
...
## 467 API 文档 / API_Filter_Criteria
...
## 469 API 文档 / API_Filter_FilterId
...
## 471 API 文档 / API_Filters_Filters 对象
...
## 473 API 文档 / API_Filters_Operator
...
## 479 API 文档 / API_Group_IsAscending
...
## 482 API 文档 / API_Groups_Groups 对象
...
## 484 API 文档 / API_Groups_IsTempUnFold
...
## 488 API 文档 / API_Groups_UnFoldAll
...
## 489 API 文档 / API_DbComment_DbComment 对象
...
## 492 API 文档 / API_DbComment_Delete
...
## 493 API 文档 / API_RecordComment_RecordComment 对象
...
## 494 API 文档 / API_RecordComment_Count
...
## 495 API 文档 / API_RecordComment_Add
...
## 496 API 文档 / API_RecordComment_Delete
...
## 497 API 文档 / API_RecordComment_Item
...
## 498 API 文档 / API_RecordComments_RecordComments 对象
...
## 499 API 文档 / API_RecordComments_Count
...
## 500 API 文档 / API_RecordComments_Item
...
## 501 API 文档 / API_RecordComments_OnCreate
...
## 502 API 文档 / API_RecordComments_OnDelete
...
## 503 API 文档 / API_DataSource_DataSource 对象
...
## 504 API 文档 / API_DataSource_CreateSummarySheet
...
## 505 API 文档 / API_DataSource_CreateSyncDBSheets
...
## 506 API 文档 / API_DataSource_ImportFromCloud
...
## 507 API 文档 / API_DataSource_ImportFromLocal
...
## 508 API 文档 / API_SummarySheet_SummarySheet 对象
...
## 509 API 文档 / API_SummarySheet_SourceConfigs
...
## 510 API 文档 / API_SummarySheet_RefreshSyncSheet
...
## 511 API 文档 / API_SummarySheet_RemoveSheetSyncLink
...
## 512 API 文档 / API_SummarySourceConfig_SummarySourceConfig 对象
...
## 513 API 文档 / API_SummarySourceConfig_FileId
...
## 514 API 文档 / API_SummarySourceConfig_SheetIds
...
## 515 API 文档 / API_SummarySourceConfig_SetSheets
...
## 516 API 文档 / API_SummarySourceConfig_SetUrl
...
## 517 API 文档 / API_SummarySourceConfigs_SummarySourceConfigs 对象
...
## 518 API 文档 / API_SummarySourceConfigs_Count
...
## 519 API 文档 / API_SummarySourceConfigs_Add
...
## 520 API 文档 / API_SummarySourceConfigs_Apply
...
## 521 API 文档 / API_SummarySourceConfigs_Delete
...
## 522 API 文档 / API_SummarySourceConfigs_Item
...
## 523 API 文档 / API_SyncDBSheet_SyncDBSheet 对象
...
## 524 API 文档 / API_SyncDBSheet_RefreshSyncSheet
...
## 525 API 文档 / API_SyncDBSheet_RemoveSheetSyncLink
...
## 526 API 文档 / API_NoticeBar_NoticeBar 对象
...
## 527 API 文档 / API_NoticeBar_Visible
...
## 528 API 文档 / API_ApiResult_ApiResult 对象
...
## 530 API 文档 / API_ApiResult_Message
...
## 531 API 文档 / API / 枚举值 / DbAutomationPresetType
...
## 532 API 文档 / API / 枚举值 / DbButtonIcon
...
## 533 API 文档 / API / 枚举值 / DbFieldValueType
...
## 534 API 文档 / API / 枚举值 / DbFilterCriteriaOpType
...
## 535 API 文档 / API / 枚举值 / DbGroupUnit
...
## 536 API 文档 / API / 枚举值 / DbLookupFunction
...
## 537 API 文档 / API / 枚举值 / DbSharedCriteriaType
...
## 538 API 文档 / API / 枚举值 / FilterOpType
...
## 539 API 文档 / API / 枚举值 / SharedLinkPermissionType
...
## 540 API 文档 / API / 枚举值 / SharedLinkToType
...
## 543 API 文档 / API_Interior_Interior 对象
...
## 545 API 文档 / API_Navigator_Navigator 对象
...
## 546 API 文档 / API_Navigator_Visible
...
## 547 API 文档 / API_Window_Window 对象
...
## 548 API 文档 / API_Window_GanttViewUI
...
## 549 API 文档 / API_Window_Navigator
...
## 550 API 文档 / API_Window_NoticeBar
...
## 551 API 文档 / API_Window_BailHook
...
## 552 API 文档 / API_Window_DisplayRecord
...
## 553 API 文档 / API_Window_HiddenAllRecord
...
## 554 API 文档 / API_Window_SetLayout
